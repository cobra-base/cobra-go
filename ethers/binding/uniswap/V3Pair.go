...
// UniswapV3PairMetaData contains all meta data concerning the UniswapV3Pair contract.
var UniswapV3PairMetaData = &bind.MetaData{
...
// Deprecated: Use UniswapV3PairMetaData.ABI instead.
var UniswapV3PairABI = UniswapV3PairMetaData.ABI
...
func bindUniswapV3Pair(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := UniswapV3PairMetaData.GetAbi()
	if err != nil {
		return nil, err
	}
